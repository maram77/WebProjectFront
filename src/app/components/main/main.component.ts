...
export class MainComponent implements OnInit {
  ...
  constructor(public router: Router, private cartService: CartService, public sidenavMenuService:SidebarMenuService) {
    const cartId = 1; // Hardcoded for testing purposes
    this.cartService.getProductsByCartId(cartId).subscribe(shoppingCartItems => this.shoppingCartItems = shoppingCartItems);
