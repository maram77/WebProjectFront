...
export class ProductDetailsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, public productsService: ProductService, public dialog: MatDialog, private router: Router, private cartService: CartService) {
    this.route.params.subscribe(params => {
      const id = params['id']; // Le paramètre id est déjà une chaîne de caractères, donc pas besoin de conversion
      this.productsService.getProductByReference(id).subscribe(product => this.product = product)
    });
   }
